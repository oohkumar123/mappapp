<template>
    <div id="destinations">
        ...
        <div class="destinations-list sortable-list" ref="sortableList">
            <article class="item" :class="'item ' + index"  draggable="true" ref="item" v-for="(item, index) in locationsList" :key="index">
                <div class="details">
                    <div
                        class="order"
...
export default {
    ...
    mounted() {
        this.makeDestinationsDraggable2();
        this.makeDestinationsDraggable();
        this.addStats();
    },
    updated() {
        this.makeDestinationsDraggable2();
    ...
    methods: {
        makeDestinationsDraggable2() {
            console.info('%clocationsList 2: %o', 'color: red;font-size:12px', this.locationsList);

        },

        makeDestinationsDraggable() {
